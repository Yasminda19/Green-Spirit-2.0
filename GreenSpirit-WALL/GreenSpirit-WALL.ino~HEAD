...
Teta[1]= (teta + 150)/300*360;
Teta[2]= (150 - teta)/300*360;
Teta[3]= (teta + 150)/300*360;
Teta[4]= (150 - teta)/300*360;
Teta[5]= (teta + 150)/300*360;
Teta[6]= (150 - teta)/300*360;
Gamma[1]= (gamma + 60 )/300*360;
Gamma[2]= (240 - gamma)/300*360;
Gamma[3]= (gamma + 60 )/300*360;
Gamma[4]= (240 - gamma)/300*360;
Gamma[5]= (240 - gamma)/300*360;
Gamma[6]= (gamma + 60 )/300*360;
Alpa[1]= (240 - alpa)/300*360;
Alpa[2]= (alpa + 60 )/300*360;
Alpa[3]= (240 - alpa)/300*360;
Alpa[4]= (alpa + 60 )/300*360;
Alpa[5]= (alpa + 60 )/300*360;
Alpa[6]= (240 - alpa)/300*360;
...
int servangle ;
//is the angle of servo.
    //loop to read the analog value of the sensors
/* for(servangle = 0;servangle<180;servangle++){
  for(int k=0;k<180;k++){
...
Serial.print("Teta[5] : "); 
Serial.print(Teta[5]);
Serial.print("  Gamma[5] : "); 
Serial.print(Gamma[5]);
Serial.print("  Alpa[5] : "); 
Serial.println(Alpa[5]);
////////////////////////////////////////////////////// kaki 2 3 6 dorong
x=60;
y=60-y1;
z=50-z1+z1;
...
Serial.print("Teta[2] : "); 
Serial.print(Teta[2]);
Serial.print("  Gamma[2] : "); 
Serial.print(Gamma[2]);
Serial.print("  Alpa[2] : "); 
Serial.println(Alpa[2]);
x=60;
y=30-y1;
z=50-z1+z1;
hitung_invers_kinematik();
